        ...
        <link rel="manifest" href="/site.webmanifest"/>
            ...
            <div className='Header'>
                <div className='header_up'>
                    ...
                    <p className='header_up_img_title'>HR - агентство</p>
                    <div className='header_up_text'>
                        <a className='header_up_text_1' href='#first'>Почему мы</a>
                        <a className='header_up_text_2' href='#about'>О нас</a>
                        <a className='header_up_text_3' href='#cash'>Стоимость</a>
                        <a className='header_up_text_4' href='#keys'>Отзывы и кейсы</a>
                        <a className='header_up_text_5' href='#foot'>Контакты</a>
                    </div>
                </div>
                <div className='header_top' id='first'>
                    ...
                    <div className='header_top_text'>
                        ...
                        <a href='/mail-completed/client/index.html'>
                        <p className='header_top_price_price'>Оставить заявку</p>
                        </a>
                ...
                <div className='header_price'>
                    <h2 className='header_price_title' id='cash'>Расчет стоимости</h2>
                ...
                <div className='header_otziv'>
                    <h2 className='header_otziv_title' id='#keys'>Наши кейсы</h2>
                ...
                <div className='header_footer' id='foot'>
                    <img className='header_footer_img' src='/public/logo.png'/>
                    <p className='header_footer_title'>HR - агентство</p>
                    <p className='header_footer_mail'>npmedia@mail.ru</p>
                    <p className='header_footer_number'>+7 928 333-63-36</p>
                    <div className='header_footer_up_text'>
                        <a className='header_up_text_1' href='#first'>Почему мы</a>
                        <a className='header_up_text_2' href='#about'>О нас</a>
                        <a className='header_up_text_3' href='#cash'>Стоимость</a>
                        <a className='header_up_text_4' href='#keys'>Отзывы и кейсы</a>
